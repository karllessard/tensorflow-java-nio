 ...
 * exceed 2<sup>32</sup> - 1 (see {@link ByteJdkDataBuffer.MAX_CAPACITY} for the real maximum value
 * supported).
 */
public final class ByteJdkDataBuffer extends AbstractJdkDataBuffer<Byte, ByteDataBuffer> implements
    ByteDataBuffer {
  ...
  public Stream<Byte> stream() {
    throw new UnsupportedOperationException(
        "ByteDataBuffer does not support value streaming at the moment");
  }
