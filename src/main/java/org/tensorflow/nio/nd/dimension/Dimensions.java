...
public final class Dimensions {
  ...
  public static Dimension unknown() { return new UnknownDimension(); }
  ...
  public static Dimension withIndex(Index index, Dimension originalDimension) {
    return new IndexedDimension(index, (AbstractDimension)originalDimension);
  }
}
